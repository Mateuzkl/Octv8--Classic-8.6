...
function onMiniWindowOpen()
    if not imbuementTrackerButton then
        imbuementTrackerButton = modules.game_interface.getRightPanel():recursiveGetChildById('imbuementTrackerButton')
    end
...
function toggle()
    ...
    if imbuementTracker:isVisible() then
...
function onGameStart()
    ...
    imbuementTrackerButton = rightPanel:recursiveGetChildById('imbuementTrackerButton')
    if imbuementTrackerButton then
        g_game.imbuementDurations(imbuementTrackerButton:isOn())
    end
    loadFilters()
